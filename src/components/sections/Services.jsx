...
const services = [
  {
    ...
    description:
      "Native and cross-platform mobile solutions designed for performance and intuitive user journeys.",
    features: [
      "iOS & Android Native",
  ...
  },
  {
    ...
    description:
      "Scalable, secure, and highly-performant web applications that power modern business operations.",
    features: [
  ...
  },
  {
    ...
    title: "Desktop apps",
    description:
      "Robust desktop solutions for Windows and macOS with native feel.",
    size: "small",
  },
  {
    icon: "cloud_done",
    title: "SaaS Products",
    description:
      "Multi-tenant architecture and subscription management platforms.",
    size: "small",
  },
  {
          ...
          <div className="md:col-span-4 md:pb-4">
            <AnimatedSection variant="fadeInUp" delay={0.2}>
              <p className="text-lg leading-relaxed text-zinc-600 max-w-sm">
                Architecting digital solutions that bridge the gap between
                technical rigor and creative expression. We build for the future
                of the web.
              </p>
            </AnimatedSection>
          </div>
              ...
              >
                <div className="relative z-10">
                  ...
                  <p className="text-zinc-400 max-w-xs">
                    The engine room: secure, lightning-fast data architecture.
                  </p>
                </div>
              ...
              >
                <div className="relative z-10">
                  ...
                  <p className="text-on-secondary-fixed-variant max-w-xs">
                    Ensuring longevity and constant evolution of your product.
                  </p>
                </div>
